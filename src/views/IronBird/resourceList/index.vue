<template>
  <n-space :vertical="true" :size="16">
    ...
    <n-card title="计算资源利用率示意图" :bordered="false" class="rounded-16px shadow-sm">
      <div ref="lineRef" class="h-400px"></div>
    </n-card>
    <!-- <n-card :bordered="false" class="rounded-16px shadow-sm">
      <div ref="barRef" class="h-400px"></div>
    </n-card> -->
    <n-card title="CPU利用率示意图" :bordered="false" class="rounded-16px shadow-sm">
